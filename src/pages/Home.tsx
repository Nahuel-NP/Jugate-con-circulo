...
const Home = () => {
  ...
  return (
    <div className="relative z-10 flex flex-col items-center justify-center w-full h-full gap-10 bg-center bg-cover saturate-150" style={{ viewTransitionName: 'view', background: 'linear-gradient(90deg, rgba(29, 183, 179, 0.50) 0%, rgba(45, 169, 182, 0.50) 19%, rgba(88, 132, 188, 0.50) 56%, rgba(145, 83, 197, 0.50) 100% )' }}>
