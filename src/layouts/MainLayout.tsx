...
const MainLayout = () => {
  return (
    <main className="relative bg-fixed bg-center bg-cover bg-montana font-rubik">
      ...
      <Outlet />
      <img style={{ viewTransitionName: 'mountains' }} src="/images/backgrounds/montana/front_2.png" className="fixed bottom-0 z-10 w-full " loading="lazy" decoding="async" alt="mountains" />
