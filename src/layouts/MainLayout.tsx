...
const MainLayout = () => {
  return (
    <main className="relative bg-fixed bg-center bg-cover bg-montana font-rubik">
      ...
      <Outlet />
      <img style={{ viewTransitionName: 'mountains',zIndex:20 }} src="/images/backgrounds/montana/front.webp" className="fixed bottom-0 w-full " loading="lazy" decoding="async" alt="mountains" />
